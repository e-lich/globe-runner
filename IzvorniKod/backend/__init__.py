...
app.config['SESSION_REDIS'] = redis.Redis(host=os.getenv('REDIS_HOST'), port=int(os.getenv('REDIS_PORT')), db=0, password=os.getenv('REDIS_PASSWORD'), username=os.getenv('REDIS_USER'))
