\chapter{Opis projektnog zadatka}
    \section{Uvod}
		...
		Za registraciju \underbar{kartografa} (\textit{Cartographer}) potrebni su i sljedeći podatci:
		\begin{packed_item}
		...
		\underbar{Administrator} (\textit{Admin}) ima ulogu nadgledanja korisnika, lokacija i kartografa, a u tu svrhu u svom izborniku ima pristup sljedećim stranicama:
	...
	%pocetak komentara (latex primjeri)
	\iffalse
