...
%	\textit{Potrebno je priložiti dijagram aktivnosti s pripadajućim opisom. Dijagram aktivnosti treba prikazivati značajan dio sustava.}\\
			...
			Slika \ref{fig:ActivityDiagram} prikazuje dijagram aktivnosti koji svojim nizom akcija pobliže objašnjava značajan dio našeg sustava. Glavna akcija u našoj aplikaciji je borba pa smo modelirali sva ponašanja koja vode do kreiranja i odvijanja same borbe. Korisnik se najprije mora prijaviti u sustav te ako su njegovi podaci ispravni, prikaže mu se početna stranica sa mapom i karticama koje može sakupiti. Ako njegovi podaci nisu ispravni, korisnika se preusmjerava nazad na login stranicu. Nakon uspješne prijave, pretpostavimo da je korisnik već sakupio minimalno 3 kartice, on odabire želi li izazvati aktivne igrače u blizini ili prihvatiti izazov od strane drugih igrača, ukoliko oni postoje. Za prvu opciju korisnik bira polje "Nearby players" u padajućem izborniku "Menu" i dobiva popis dostupnih igrača, dok za drugu opciju, odabire ikonu prekriženih mačeva i vidi popis izazova. Da bi korisnik pokrenuo borbu mora ili prihvatiti neki od izazova ili odabrati nekog igrača koji ima uvjete za mogućnost igranja borbe (player mora biti challengable) te pričekati da izazvani igrač prihvati izazov. Kada je postupak borbe pokrenut, igrači biraju kartice s kojima se žele boriti i aplikacija računa iznos njihovih bodova. Na kraju, svi podaci se spremaju u bazu zbog zapisivanja statistike i aplikacija vraća status, odnosno je li korisnik pobijedio ili izgubio u borbi.
