\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\noindent \underbar{\textbf{UC15 - Pregled vlastitih predloženih lokacija koje čekaju pregled}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC16 - Pregled vlastitih predloženih lokacija koje su odobrene}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC17 - Pregled prijedloga novih lokacija}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC18 - Uređivanje prijedloga novih lokacija}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC19 - Odobravanje prijedloga novih lokacija}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC20 - Označavanje lokacije za terensku provjeru}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC21 - Pregled i preuzimanje kartica kojima je potrebna terenska provjera}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC22 - Uklanjanje lokacija s vlastite liste za pregled lokacija na terenu}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC23 - Generiranje rute na temelju odabranih lokacija za terensku provjeru}}
					\begin{packed_item}
	
						\item \textbf{Glavni sudionik: }Kartograf
						\item  \textbf{Cilj:} Generirati najkraću rutu za obilazak odabranih lokacija
						\item  \textbf{Sudionici:} Baza podataka, OSRM servis
						\item  \textbf{Preduvjet:} Kartograf je prijavljen
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\noindent \underbar{\textbf{UC24 - Odobravanje lokacije s vlastite liste za terensku provjeru}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC26 - Pregled osobnih podataka svih korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC27 - Uređivanje osobnih podataka nekog korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC30 - Uređivanje podataka neke lokacije}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC31 - Pregled neodobrenih registracija kartografa}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC32 - Odobravanje registracija kartografa}}
					\begin{packed_item}
